...
class Migration(migrations.Migration):
    dependencies = [
        ("microsite", "0074_alter_generalpurposepage_content_and_more"),
    ]
                            ...
                            [
                                (
                                    ...
                                    wagtail.blocks.ChoiceBlock(
                                        ...
                                        help_text="Remember to respect best practices around heirarchy of header size: <a href='https://developer.mozilla.org/en-US/docs/Web/HTML/Element/Heading_Elements#usage_notes'>See MDN</a>",
                                    ),
                                ),
                                (
                                    "alignment",
