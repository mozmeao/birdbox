...
# Generated by Django 4.1.10 on 2023-07-14 22:24
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("microsite", "0033_alter_protocoltestpage_body"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("standfirst", models.CharField(blank=True, max_length=500)),
                (
                    "body",
                ...
                (
                    "custom_authors_text",
                    models.CharField(
                        blank=True, help_text="If set, will override any automatic author name(s) from the linked users", max_length=150
                    ),
                ),
                ("header_image_alt_text", models.CharField(blank=True, max_length=500)),
            ...
            fields=[
                ...
                (
                    ...
                    modelcluster.fields.ParentalKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="tagged_items", to="microsite.blogpage"
                    ),
                ),
                (
                    "tag",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="%(app_label)s_%(class)s_items", to="taggit.tag"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.AddField(
            ...
            field=modelcluster.contrib.taggit.ClusterTaggableManager(
                blank=True, help_text="A comma-separated list of tags.", through="microsite.BlogPageTag", to="taggit.Tag", verbose_name="Tags"
            ),
        ),
    ]
