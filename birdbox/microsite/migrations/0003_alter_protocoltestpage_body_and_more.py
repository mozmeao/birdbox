...
# Generated by Django 4.1.9 on 2023-06-21 21:38
...
class Migration(migrations.Migration):
    dependencies = [
        ("microsite", "0002_protocoltestpage_delete_general"),
    ]
    ...
    operations = [
                                    ...
                                    wagtail.blocks.ListBlock(
                                        wagtail.blocks.StructBlock(
                                            [
                                                ...
                                                ("image", wagtail.images.blocks.ImageChooserBlock(required=False)),
                                                ("tags", wagtail.blocks.ListBlock(wagtail.blocks.CharBlock(label="tag"))),
                                            ]
                                        )
                                    ),
                                ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                help_text="Optional layout wrapper for the entire page. <a href='https://protocol.mozilla.org/components/detail/content-container--default.html'>See Protocol docs</a>.",
                max_length=64,
            ),
        ),
    ]
